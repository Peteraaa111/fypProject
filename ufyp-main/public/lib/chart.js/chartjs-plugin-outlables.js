/*!
 * chartjs-plugin-outlables v2.0.0
 * https://chartjs-plugin-outlables.netlify.app
 * (c) 2017-2021 chartjs-plugin-outlables contributors
 * Released under the MIT license
 */
(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
typeof define === 'function' && define.amd ? define(factory) :
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ChartOutLabels = factory());
	...
	OutLabel: function(el, index, ctx, config, context) {
		...
		this.init = function(text, lines) {
			...
			this.style = {
				...
				color: resolve([config.color, defaults.color], context, index),
